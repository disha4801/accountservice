...
import com.dnb.apigatewayservice.exception.JwtTokenMalformedException;
import com.dnb.apigatewayservice.exception.JwtTokenMissingException;
import com.dnb.apigatewayservice.util.JwtUtils;
...
public class JwtAuthenticationFilter implements GatewayFilter {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        System.out.println("helloo security filter");
